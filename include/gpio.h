...
#define GPIO_DIR0 ((GPIO_base + 0x0000)) // 0 - Input/1 - Output
...
#define GPIO_DIR1_SET ((GPIO_base + 0x0014))
#define GPIO_DIR1_CLR ((GPIO_base + 0x0018))
#define GPIO_DIR1_MASK 0x00CFFFFFF
#define GPIO_SETDIRIN(Pin)                                                     \
  do {                                                                         \
    typeof(Pin) p = Pin;                                                       \
    if (p < 0x20)                                                              \
      writel((1UL << p), GPIO_DIR0_CLR);                                       \
    else if (p < 0x40)                                                         \
      writel((1UL << (p - 0x20)), GPIO_DIR1_CLR);                              \
  } while (0)
#define GPIO_SETDIROUT(Pin)                                                    \
  do {                                                                         \
    typeof(Pin) p = Pin;                                                       \
    if (p < 0x20)                                                              \
      writel((1UL << p), GPIO_DIR0_SET);                                       \
    else if (p < 0x40)                                                         \
      writel((1UL << (p - 0x20)), GPIO_DIR1_SET);                              \
  } while (0)

#define GPIO_PULLEN0 ((GPIO_base + 0x0100)) // 0 - Disable/1 - Enable
#define GPIO_PULLEN0_SET ((GPIO_base + 0x0104))
#define GPIO_PULLEN0_CLR ((GPIO_base + 0x0108))
#define PULLEN0_MASK 0x43C00BFF
#define GPIO_PULLEN1 ((GPIO_base + 0x0110))
#define GPIO_PULLEN1_SET ((GPIO_base + 0x0114))
#define GPIO_PULLEN1_CLR ((GPIO_base + 0x0118))
...
#define GPIO_PULLENABLE(Pin)                                                   \
  do {                                                                         \
    ...
    if (p < 0x20) {                                                            \
      v = (1UL << p);                                                          \
      if (v & PULLSEL0_MASK)                                                   \
        writel(v, GPIO_PULLEN0_SET);                                           \
      else if (v & RESEN0_0_MASK)                                              \
        writel(v, GPIO_RESEN0_0_SET);                                          \
    } else if (p < 0x40) {                                                     \
      v = (1UL << (p - 0x20));                                                 \
      if (v & PULLSEL1_MASK)                                                   \
        writel(v, GPIO_PULLEN1_SET);                                           \
      else if (v & RESEN0_1_MASK)                                              \
        writel(v, GPIO_RESEN0_1_SET);                                          \
    }                                                                          \
  } while (0)
#define GPIO_PULLDISABLE(Pin)                                                  \
  do {                                                                         \
    ...
    if (p < 0x20) {                                                            \
      v = (1UL << p);                                                          \
      if (v & PULLSEL0_MASK)                                                   \
        writel(v, GPIO_PULLEN0_CLR);                                           \
      else if (v & RESEN0_0_MASK)                                              \
        writel(v, GPIO_RESEN0_0_CLR);                                          \
    } else if (p < 0x40) {                                                     \
      v = (1UL << (p - 0x20));                                                 \
      if (v & PULLSEL1_MASK)                                                   \
        writel(v, GPIO_PULLEN1_CLR);                                           \
      else if (v & RESEN0_1_MASK)                                              \
        writel(v, GPIO_RESEN0_1_CLR);                                          \
    }                                                                          \
  } while (0)

#define GPIO_DINV0 ((GPIO_base + 0x0200))
#define GPIO_DINV0_SET ((GPIO_base + 0x0204))
#define GPIO_DINV0_CLR ((GPIO_base + 0x0208))
#define GPIO_DINV1 ((GPIO_base + 0x0210))
#define GPIO_DINV1_SET ((GPIO_base + 0x0214))
#define GPIO_DINV1_CLR ((GPIO_base + 0x0218))

#define GPIO_DOUT0 ((GPIO_base + 0x0300))
#define GPIO_DOUT0_SET ((GPIO_base + 0x0304))
#define GPIO_DOUT0_CLR ((GPIO_base + 0x0308))
#define GPIO_DOUT1 ((GPIO_base + 0x0310))
#define GPIO_DOUT1_SET ((GPIO_base + 0x0314))
#define GPIO_DOUT1_CLR ((GPIO_base + 0x0318))
...
#define GPIO_DIN1 ((GPIO_base + 0x0410))
#define GPIO_DATAIN(Pin)                                                       \
  ({                                                                           \
    typeof(Pin) p = Pin;                                                       \
    (p < 0x20)   ? ((GPIO_DIN0 & (1UL << p)) ? true : false)                   \
    : (p < 0x40) ? ((GPIO_DIN1 & (1UL << (p - 0x20))) ? true : false)          \
                 : false;                                                      \
  })

#define GPIO_PULLSEL0 ((GPIO_base + 0x0500)) // 0 - PullDown/1 - PullUp
#define GPIO_PULLSEL0_SET ((GPIO_base + 0x0504))
#define GPIO_PULLSEL0_CLR ((GPIO_base + 0x0508))
#define PULLSEL0_MASK 0x43C00BFF
#define GPIO_PULLSEL1 ((GPIO_base + 0x0510)) // 0 - PullDown/1 - PullUp
#define GPIO_PULLSEL1_SET ((GPIO_base + 0x0514))
#define GPIO_PULLSEL1_CLR ((GPIO_base + 0x0518))
...
#define GPIO_SETPULLUP(Pin)                                                    \
  do {                                                                         \
    ...
    if (p < 0x20) {                                                            \
      v = (1UL << p);                                                          \
      if (v & PULLSEL0_MASK)                                                   \
        writel(v, GPIO_PULLSEL0_SET);                                          \
      else if (v & PUPD0_MASK)                                                 \
        writel(v, GPIO_PUPD0_CLR);                                             \
    } else if (p < 0x40) {                                                     \
      v = (1UL << (p - 0x20));                                                 \
      if (v & PULLSEL1_MASK)                                                   \
        writel(v, GPIO_PULLSEL1_SET);                                          \
      else if (v & PUPD1_MASK)                                                 \
        writel(v, GPIO_PUPD1_CLR);                                             \
    }                                                                          \
  } while (0)
#define GPIO_SETPULLDOWN(Pin)                                                  \
  do {                                                                         \
    ...
    if (p < 0x20) {                                                            \
      v = (1UL << p);                                                          \
      if (v & PULLSEL0_MASK)                                                   \
        writel(v, GPIO_PULLSEL0_CLR);                                          \
      else if (v & PUPD0_MASK)                                                 \
        writel(v, GPIO_PUPD0_SET);                                             \
    } else if (p < 0x40) {                                                     \
      v = (1UL << (p - 0x20));                                                 \
      if (v & PULLSEL1_MASK)                                                   \
        writel(v, GPIO_PULLSEL1_CLR);                                          \
      else if (v & PUPD1_MASK)                                                 \
        writel(v, GPIO_PUPD1_SET);                                             \
    }                                                                          \
  } while (0)

#define GPIO_SMT0 ((GPIO_base + 0x0600)) // Schmitt trigger control
#define GPIO_SMT0_SET ((GPIO_base + 0x0604))
#define GPIO_SMT0_CLR ((GPIO_base + 0x0608))
#define GPIO_SMT0_MASK 0xFFFFFFFF
#define GPIO_SMT1 ((GPIO_base + 0x0610))
#define GPIO_SMT1_SET ((GPIO_base + 0x0614))
#define GPIO_SMT1_CLR ((GPIO_base + 0x0618))
...
#define GPIO_SMTENABLE(Pin)                                                    \
  do {                                                                         \
    ...
    if (p < 0x20) {                                                            \
      v = 1UL << p;                                                            \
      if (v & GPIO_SMT0_MASK)                                                  \
        writel((1UL << p), GPIO_SMT0_SET);                                     \
    } else if (p < 0x40) {                                                     \
      v = 1UL << (p - 0x20);                                                   \
      if (v & GPIO_SMT1_MASK)                                                  \
        writel((1UL << (p - 0x20)), GPIO_SMT1_SET);                            \
    }                                                                          \
  } while (0)
#define GPIO_SMTDISABLE(Pin)                                                   \
  do {                                                                         \
    ...
    if (p < 0x20) {                                                            \
      v = 1UL << p;                                                            \
      if (v & GPIO_SMT0_MASK)                                                  \
        writel((1UL << p), GPIO_SMT0_CLR);                                     \
    } else if (p < 0x40) {                                                     \
      v = 1UL << (p - 0x20);                                                   \
      if (v & GPIO_SMT1_MASK)                                                  \
        writel((1UL << (p - 0x20)), GPIO_SMT1_CLR);                            \
    }                                                                          \
  } while (0)

#define GPIO_SR0 ((GPIO_base + 0x0700)) // Slew rate control
#define GPIO_SR0_SET ((GPIO_base + 0x0704))
#define GPIO_SR0_CLR ((GPIO_base + 0x0708))
#define GPIO_SR1 ((GPIO_base + 0x0710))
#define GPIO_SR1_SET ((GPIO_base + 0x0714))
#define GPIO_SR1_CLR ((GPIO_base + 0x0718))
#define GPIO_SIM_SR ((GPIO_base + 0x0720))
#define GPIO_SIM_SR_SET ((GPIO_base + 0x0724))
#define GPIO_SIM_SR_CLR ((GPIO_base + 0x0728))

#define GPIO_DRV0 ((GPIO_base + 0x0800))
#define GPIO_DRV0_SET ((GPIO_base + 0x0804))
#define GPIO_DRV0_CLR ((GPIO_base + 0x0808))
#define GPIO_DRV1 ((GPIO_base + 0x0810))
#define GPIO_DRV1_SET ((GPIO_base + 0x0814))
#define GPIO_DRV1_CLR ((GPIO_base + 0x0818))

#define GPIO_IES0 ((GPIO_base + 0x0900))
#define GPIO_IES0_SET ((GPIO_base + 0x0904))
#define GPIO_IES0_CLR ((GPIO_base + 0x0908))
#define GPIO_IES0_MASK 0x43C00BFF
#define GPIO_IES1 ((GPIO_base + 0x0910))
#define GPIO_IES1_SET ((GPIO_base + 0x0914))
#define GPIO_IES1_CLR ((GPIO_base + 0x0918))
...
#define GPIO_SETINPUTEN(Pin)                                                   \
  do {                                                                         \
    ...
    if (p < 0x20) {                                                            \
      v = 1UL << p;                                                            \
      if (v & GPIO_IES0_MASK)                                                  \
        writel((1UL << p), GPIO_IES0_SET);                                     \
    } else if (p < 0x40) {                                                     \
      v = 1UL << (p - 0x20);                                                   \
      if (v & GPIO_IES1_MASK)                                                  \
        writel((1UL << (p - 0x20)), GPIO_IES1_SET);                            \
    }                                                                          \
  } while (0)
#define GPIO_SETINPUTDIS(Pin)                                                  \
  do {                                                                         \
    ...
    if (p < 0x20) {                                                            \
      v = 1UL << p;                                                            \
      if (v & GPIO_IES0_MASK)                                                  \
        writel((1UL << p), GPIO_IES0_CLR);                                     \
    } else if (p < 0x40) {                                                     \
      v = 1UL << (p - 0x20);                                                   \
      if (v & GPIO_IES1_MASK)                                                  \
        writel((1UL << (p - 0x20)), GPIO_IES1_CLR);                            \
    }                                                                          \
  } while (0)
...
//  1   1   0   PD-47k
//  1   1   1   PD-23.5k
#define GPIO_PUPD0 ((GPIO_base + 0x0A00)) // Select pullup/pulldown
#define GPIO_PUPD0_SET ((GPIO_base + 0x0A04))
#define GPIO_PUPD0_CLR ((GPIO_base + 0x0A08))
#define PUPD0_MASK 0xBC3FF400
#define GPIO_PUPD1 ((GPIO_base + 0x0A10))
#define GPIO_PUPD1_SET ((GPIO_base + 0x0A14))
#define GPIO_PUPD1_CLR ((GPIO_base + 0x0A18))
#define PUPD1_MASK 0x000FE7FF

#define GPIO_RESEN0_0 ((GPIO_base + 0x0B00)) // R0 control
#define GPIO_RESEN0_0_SET ((GPIO_base + 0x0B04))
#define GPIO_RESEN0_0_CLR ((GPIO_base + 0x0B08))
#define RESEN0_0_MASK 0xBC3FF400
#define GPIO_RESEN0_1 ((GPIO_base + 0x0B10)) // R0 control
#define GPIO_RESEN0_1_SET ((GPIO_base + 0x0B14))
#define GPIO_RESEN0_1_CLR ((GPIO_base + 0x0B18))
#define RESEN0_1_MASK 0x000FE7FF
#define GPIO_RESEN1_0 ((GPIO_base + 0x0B20)) // R1 control
#define GPIO_RESEN1_0_SET ((GPIO_base + 0x0B24))
#define GPIO_RESEN1_0_CLR ((GPIO_base + 0x0B28))
#define RESEN1_0_MASK 0xBC3FF400
#define GPIO_RESEN1_1 ((GPIO_base + 0x0B30)) // R1 control
#define GPIO_RESEN1_1_SET ((GPIO_base + 0x0B34))
#define GPIO_RESEN1_1_CLR ((GPIO_base + 0x0B38))
#define RESEN1_1_MASK 0x000FE7FF

#define GPIO_MODE(x) ((GPIO_base + 0x0C00 + 0x10 * (x)))
#define GPIO_MODE_SET(x) ((GPIO_base + 0x0C04 + 0x10 * (x)))
#define GPIO_MODE_CLR(x) ((GPIO_base + 0x0C08 + 0x10 * (x)))

#define GPIO_MODE0 ((GPIO_base + 0x0C00))
#define GPIO_MODE0_SET ((GPIO_base + 0x0C04))
#define GPIO_MODE0_CLR ((GPIO_base + 0x0C08))
#define GPIO_MODE0MASK                                                         \
  ((GPIO00_MASK << 0) | (GPIO01_MASK << 4) | (GPIO02_MASK << 8) |              \
...
#define GPIO_MODE1 ((GPIO_base + 0x0C10))
#define GPIO_MODE1_SET ((GPIO_base + 0x0C14))
#define GPIO_MODE1_CLR ((GPIO_base + 0x0C18))
#define GPIO_MODE1MASK                                                         \
  ((GPIO08_MASK << 0) | (GPIO09_MASK << 4) | (GPIO10_MASK << 8) |              \
...
#define GPIO_MODE2 ((GPIO_base + 0x0C20))
#define GPIO_MODE2_SET ((GPIO_base + 0x0C24))
#define GPIO_MODE2_CLR ((GPIO_base + 0x0C28))
#define GPIO_MODE2MASK                                                         \
  ((GPIO16_MASK << 0) | (GPIO17_MASK << 4) | (GPIO18_MASK << 8) |              \
...
#define GPIO_MODE3 ((GPIO_base + 0x0C30))
#define GPIO_MODE3_SET ((GPIO_base + 0x0C34))
#define GPIO_MODE3_CLR ((GPIO_base + 0x0C38))
#define GPIO_MODE3MASK                                                         \
  ((GPIO24_MASK << 0) | (GPIO25_MASK << 4) | (GPIO26_MASK << 8) |              \
...
#define GPIO_MODE4 ((GPIO_base + 0x0C40))
#define GPIO_MODE4_SET ((GPIO_base + 0x0C44))
#define GPIO_MODE4_CLR ((GPIO_base + 0x0C48))
#define GPIO_MODE4MASK                                                         \
  ((GPIO32_MASK << 0) | (GPIO33_MASK << 4) | (GPIO34_MASK << 8) |              \
...
#define GPIO_MODE5 ((GPIO_base + 0x0C50))
#define GPIO_MODE5_SET ((GPIO_base + 0x0C54))
#define GPIO_MODE5_CLR ((GPIO_base + 0x0C58))
#define GPIO_MODE5MASK                                                         \
  ((GPIO40_MASK << 0) | (GPIO41_MASK << 4) | (GPIO42_MASK << 8) |              \
...
#define GPIO_MODE6 ((GPIO_base + 0x0C60))
#define GPIO_MODE6_SET ((GPIO_base + 0x0C64))
#define GPIO_MODE6_CLR ((GPIO_base + 0x0C68))
#define GPIO_MODE6MASK                                                         \
  ((GPIO48_MASK << 0) | (GPIO49_MASK << 4) | (GPIO50_MASK << 8) |              \
  ...
  do {                                                                         \
    ...
    if (p <= GPIOMAX) {                                                        \
      ...
      if (p < 8)                                                               \
        ...
        Mask = GPIO_MODE6MASK;                                                 \
      writel((readl(GPIO_MODE(RegIdx)) & ~(0x0FUL << ModePos)) |               \
                 (((Mode)&Mask) << ModePos),                                   \
             GPIO_MODE(RegIdx));                                               \
    }                                                                          \
  } while (0)

#define GPIO_TDSEL ((GPIO_base + 0x0D10)) // TX duty control
#define GPIO_TDSEL_SET ((GPIO_base + 0x0D14))
#define GPIO_TDSEL_CLR ((GPIO_base + 0x0D18))

#define CLK_OUT0 ((GPIO_base + 0x0E00))
#define CLK_OUT1 ((GPIO_base + 0x0E10))
#define CLK_OUT2 ((GPIO_base + 0x0E20))
#define CLK_OUT3 ((GPIO_base + 0x0E30))
#define CLK_OUT4 ((GPIO_base + 0x0E40))
#define CLK_OUT5 ((GPIO_base + 0x0E50))
#define CLKO_26MHz 1
#define CLKO_32kHz 4
